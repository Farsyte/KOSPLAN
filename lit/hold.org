...
* mphold_thrust(s) - add "wait for thrust" to mission plan (with optional status s).
...
* mphold_brakes(s) - wait until engineer taps the brakes (with optional message s).
...
* mphold_sas(s) - wait until engineer taps the sas (with optional message s).
...
* mphold_rcs(s) - wait until engineer taps the rcs (with optional message s).
...
* mphold_bay(s) - wait until engineer closes the bays (with optional message s).
