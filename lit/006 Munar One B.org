go.ks -- GO script for Munar One/B, the first MUN ORBIT

This script manages the flight of the 006 Munar One B, which
...
#+begin_src ks :results none :tangle ../Archive/home/Aben/Mun/006 Munar One/B/go.ks
  import("aeroperi").
  import("ascent").
  import("escape").
  import("fancystager").
